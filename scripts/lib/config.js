// scripts/lib/config.js — central profile/path resolution. The only place that knows the layout.
//
...
// Shared by init.js and notify_setup.js — both read/write .env keys via lib/env_file.js.
...
export function paths(name = resolveProfileName()) {
  ...
  return {
    ...
    kekaBoards: join(profileDir, "keka_boards.md"),
    ...
    kekaProbeLedger: join(dataDir, "keka_probe_ledger.json"),
    kekaSeen: join(dataDir, "keka_seen.json"),
