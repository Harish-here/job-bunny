...
test('stageCommand: runs from the empty seed payload when no checkpoint exists, checkpoints at the real index, prints the funnel line', async () => {
  ...
  const folder = new RunFolder(join(root, 'profiles', profile, 'data'), '2026-07-25');
