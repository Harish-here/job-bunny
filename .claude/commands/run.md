...
5. **/structure** — invoke the `/structure` skill. Do NOT write custom code. Reads `structure_input.md`; checkpoints every 25 rows to `jobs_raw_checkpoint.json`; writes `jobs_raw_decisions.json`.
