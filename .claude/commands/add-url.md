...
```bash
JOBBUNNY_PROFILE=<profile> node scripts/add_url.js "<paste the full LinkedIn search URL>" "<short label>"   # with profile
node scripts/add_url.js "<url>" "<short label>"                                                             # default profile / legacy
```
