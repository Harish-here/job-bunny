# Greenhouse board watchlist for the /greenhouse lane (scripts/pipeline/greenhouse.js).
...
# "- Name - token" shape makes scripts/pipeline/greenhouse.js's parseWatchlist() throw — a
...
# ## Auto-discovered is appended to automatically by the probe phase in scripts/pipeline/greenhouse.js,
